...
#rm -rf tmp/* out/* 
/home/sparcfire/bin/SpArcFiRe -convert-FITS in tmp out -clusSizeCutoff 150 -unsharpMaskAmt 6 -unsharpMaskSigma 25 -stopThres 0.1500 -mergeChkMinClusSz 25 -errRatioThres 2.5000
if [ "$?" != "0" ]; then
