...
#
#	$Id: Init.tcl.fv,v 1.2 2013/03/07 22:19:14 irby Exp $
#
# Init.tcl --
#
...
if {[info exists tix_library]} {
    set tix_library [file dirname [info nameofexecutable]]/Tix$::env(TIX_VERSION)
    set ::env(TIX_LIBRARY) $tix_library
    ::tix::Init $tix_library
}
